                    ...
                    <form method="get">
                        ...
                        <div class="cart-message">
                            ...
                            <span class="message">Có <strong>
                                ...
                                //duyet qua cac phan tu de tinh so luong
                ...
                <div class="footer-c">
                    <div class="quick-link">
                        ...
                        <ul style="margin-left: 100px">
                            ...
                            <li><strong>Email:</strong>  lienhe@babyshop.com.vn</li>
                            <li><strong>Website:</strong>  www.babyshop.com.vn</li>
                        </ul>
                        
                        <ul style="margin-left: 100px">
                            <li class="header">Thông tin cửa hàng</li>
                            <li><a href="#">Về babyshop.com.vn</a></li>
                    ...
                    <div class="copyright">
                        <p>Bản quyền © 2009-2012 babyshop.com.vn - Thiên đường cho Bé!</p>
