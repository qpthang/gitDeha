		...
		public function __construct(){
			...
			switch($act){
				case "delete":
					...
					$this->model->execute("delete from news where n_id=$id");
			...
			$total = $this->model->count("select * from news");
			...
			$arr = $this->model->fetch("select * from news order by n_id desc limit $from,$record_per_page");
			//load view
