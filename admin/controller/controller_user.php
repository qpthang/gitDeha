		...
		public function __construct(){
			...
			switch($act){
				case "delete":
					...
					$this->model->execute("delete from admin where admin_id=$id");
			...
			$total = $this->model->count("select * from admin");
			...
			$arr = $this->model->fetch("select * from admin limit $from,$record_per_page");
			//load view
