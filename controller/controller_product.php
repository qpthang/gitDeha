<?php 
	class controller_product extends controller{
		public function __construct(){
			...
			$total = $this->model->count("select * from product where fk_category_id=$category_id");
			...
			$arr = $this->model->fetch("select * from product where fk_category_id=$category_id order by product_id desc limit $from,$record_per_page");
			//load view
